...
import com.spydermama.api.common.changehistory.AuditableChild;
import com.spydermama.api.common.changehistory.ChangeHistory;
import com.spydermama.api.common.changehistory.ChangeHistoryService;
...
public abstract class BaseCrudService<T extends IdentifiableEntity<ID>, ID extends Serializable> extends BaseEntityService<T, ID> {
	...
	@Autowired
	private ChangeHistoryService auditService;
	@Autowired
	...
	public List<ChangeHistory> getHistory(ID id) {
	...
	protected List<ChangeHistory> additionalHistory(ID id) {
		return null;
	}
	...
	protected void saveChildHistory(String action, AuditableChild<?> obj, String details) {
		...
		String prefix = obj.getResourceType() + " [" + obj.getName() + "]";
...
//		if (!(obj instanceof CommonData) && (obj instanceof Auditable)) {
	...
	protected void fireResourceChangeEvent(T obj, String action) {
		...
		ResourceChangeEvent<Resource> event = new ResourceChangeEvent<Resource>(res, res.getResourceType(), action);
