...
import com.spydermama.api.common.validation.EntityReferenceValidator;
...
public @interface ParentEntityReference{
	  Class<? extends IdentifiableEntity<?>> value();
	  String message() default "Parent entity '${value.simpleName}' not found for '${validatedValue}'";
